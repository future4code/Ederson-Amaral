...
import {DivInicio, DivPerfil, Blur, FotoPerfil, DivDados, NomePerfil, IdadePerfil, Descricao, DivEscolhas, Botao, Coracao, keyframesCoracao, AnimacaoCoracao} from "./IndexStyled.js"
...
const Inicio = (props) => {
  ...
  const onClickCurtida = (curtiu) => {
    ...
    axios
      .post(
        "https://us-central1-missao-newton.cloudfunctions.net/astroMatch/ederson/choose-person", 
        body
      )
      .then(resposta=>{
      ...
      .catch(error=>{
        return alert("Falha ao curtir, tente novamente")
      })
  }
